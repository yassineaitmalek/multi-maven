package com.yatmk.test.presentation.exception;
...
import com.yatmk.test.persistence.exception.config.ClientSideException;
import com.yatmk.test.persistence.exception.config.ResourceNotFoundException;
import com.yatmk.test.persistence.exception.config.ServerSideException;
import com.yatmk.test.persistence.exception.config.TooManyRequestsException;
